 ...
 * @author igor
 */
public class BftOrderedConnection implements ClientSideConnection {

    private String configPath;
    private int clientID;
    private ServiceProxy serverConnection;
    
    public BftOrderedConnection(String cp, int cid){
        this.configPath = cp;
        this.clientID = cid;
    ...
    public void start(){
        Log.logDebug(this.getClass().getCanonicalName(), "STARTING ORDERED S-BFT CLIENT WITH ID: "+this.clientID+" AND CONFIGURATION PATH: "+this.configPath, Log.getLineNumber());
