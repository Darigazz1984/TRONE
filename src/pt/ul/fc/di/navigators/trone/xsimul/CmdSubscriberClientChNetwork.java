 ...
 * @author kreutz
 */
public class CmdSubscriberClientChNetwork {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (clientReq.isOpSuccess()) {
                ...
                Log.logWarning(CmdSubscriberClientChNetwork.class.getSimpleName(), "could not subscribe SUBSCRIBER ID: " + clientReq.getClientId() + " within channel: " + clientReq.getChannelTag(), Log.getLineNumber());
            }
        } catch (Exception ex) {
            ex.printStackTrace();
